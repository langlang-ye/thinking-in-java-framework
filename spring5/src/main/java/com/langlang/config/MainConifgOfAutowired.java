 ...
 * 		 @Qualifier 指定优先级最高  > @Primary > @Autowired 默认按照属性的名称
 * 
 * 		BookService{
 * 			@Autowired
 * 			BookDao  bookDao;
...
@Configuration
@ComponentScan({"com.langlang.service", "com.langlang.dao", "com.langlang.controller", "com.langlang.bean"})
//@ComponentScan({"com.langlang.controller", "com.langlang.dao", "com.langlang.service"})
public class MainConifgOfAutowired {
	
	@Primary
	@Bean("bookDao2")
	public BookDao bookDao() { // @Bean 名字默认是类名首字母小写
